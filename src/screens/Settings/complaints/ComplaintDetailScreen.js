...
import { getComplaintDetail } from '../../../services/complaint_service';
  ...
  const renderItem = (iconName, label, value) => (
    <View style={styles.itemRow}>
      <View style={styles.itemLeft}>
        <Icon name={iconName} size={20} color={theme.colors.primary} style={styles.itemIcon} />
        <Text style={[styles.itemLabel, { color: theme.colors.primary }]}>{label}</Text>
      </View>
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        ...
        {renderItem('category', 'Complaint Type', complaintDetail.complaint_type_name)}
