...
import useUpdateDistributor from '../../../../hooks/supplier/useUpdateDistributor';

const DistributorUpdateScreen = ({route}) => {
  ...
  const {
    ...
    handleSubmit,
    isSubmitting,
  } = useUpdateDistributor(data, id);

  return (
    <ScrollView
      keyboardShouldPersistTaps={'handled'}
      style={stylesSupplier.updateContainer}>
      <SafeAreaView />
      <View>
        <Subheading style={stylesSupplier.label}>
          General Information
        </Subheading>
        ...
        />
        {errors.email && (
          <Text style={stylesSupplier.errorText}>{errors.email}</Text>
        )}
...
export default DistributorUpdateScreen;
