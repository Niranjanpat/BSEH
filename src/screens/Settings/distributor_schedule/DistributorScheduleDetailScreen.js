...
const DistributorScheduleDetailsScreen = ({route, navigation}) => {
  ...
  const onDeletePress = () => {
    Alert.alert('Confirm', 'Proceed to delete distributor schedule', [
      {
        text: 'Cancel',
      },
      {
        text: 'Proceed',
        onPress: () => removeDistributorSchedule(id),
      },
    ]);
  };
          ...
          {status === 'pending' && (
            <>
              ...
              <Icon
                ...
                style={styles.icon}
                onPress={() =>
                  navigation.navigate(ROUTES.update_distributor_schedule, {
                    item: scheduleDetail,
                  })
                }
              />
  ...
  useEffect(() => {
    fetchDistributorScheduleDetails(id);
  }, []);
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            <View style={styles.left}>
              ...
              <Text style={styles.text}>Distributor</Text>
            </View>
            <View style={styles.right}>
              <Text>{scheduleDetail.distributor_name || 'N/A'}</Text>
            </View>
          </View>
          <View style={styles.row}>
            <View style={styles.left}>
            ...
            <View style={styles.right}>
              <Text>{scheduleDetail.distributor_sap_code || 'N/A'}</Text>
            </View>
          </View>
          <View style={styles.row}>
            <View style={styles.left}>
        ...
        <Dialog
          ...
          <Dialog.Actions>
            ...
            <Button
              onPress={() => {
                setOpen(false);
                handleDistributorCancel({reason}, id);
                setReason('');
              }}>
              Confirm
            </Button>
...
export default DistributorScheduleDetailsScreen;
